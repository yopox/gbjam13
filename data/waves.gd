...
func gen_wave(type: Types) -> Array[Spawn]:
	...
	match type:
		Types.ARROW:
			return squad(
				MovLinear.new(Util.right(16, 0.5), Values.ENEMY_SPEED, 0),
				[Enemy.Types.E1, Enemy.Types.E1, Enemy.Types.E1],
				[0, 1.25, 0], [Vector2.ZERO, Vector2(0, -12), Vector2(0, 12)]
			)
		Types.SLASH_5:
			return squad(
				MovLinear.new(Util.right(16, 0.7), Values.ENEMY_SPEED, 0),
		...
		Types.SLASH_9:
			return squad(
				MovLinear.new(Util.right(16, 0.85), Values.ENEMY_SPEED, 0),
		...
		Types.DNA:
			return [
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.5), Values.ENEMY_SPEED, Vector3(24.0, 1.5, 0.0))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.5), Values.ENEMY_SPEED, Vector3(24.0, 1.5, PI))),
			]
		Types.HATERS:
			return [
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.375), Values.ENEMY_SPEED, Vector3(10.0, 1.5, 0.0))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.625), Values.ENEMY_SPEED, Vector3(10.0, 1.5, PI))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.125), Values.ENEMY_SPEED, Vector3(10.0, 1.5, PI))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.875), Values.ENEMY_SPEED, Vector3(10.0, 1.5, 0))),
			]
		Types.FIVE:
			return [
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.3), Values.ENEMY_SPEED, Vector3(12.0, 1.5, 0.0))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.7), Values.ENEMY_SPEED, Vector3(12.0, 1.5, PI))),
				Spawn.new(2, Enemy.Types.E1, MovLinear.new(Util.right(16, 0.5), Values.ENEMY_SPEED, 0.0)),
				Spawn.new(2, Enemy.Types.E1, MovSine.new(Util.right(16, 0.3), Values.ENEMY_SPEED, Vector3(12.0, 1.5, PI))),
				Spawn.new(0, Enemy.Types.E1, MovSine.new(Util.right(16, 0.7), Values.ENEMY_SPEED, Vector3(12.0, 1.5, 0.0))),
			]
		Types.TRIO_LOOP:
			return squad(
				MovCircle.new(Util.right(16, 0.5), Values.ENEMY_SPEED, 12, 0, 2),
				[Enemy.Types.E1, Enemy.Types.E1, Enemy.Types.E1],
				[0, 1.5, 1.5],
				[Vector2(0, 24), Vector2.ZERO, Vector2(0, -24)]
			)
		Types.ORBITING:
			var spawns: Array[Spawn] = [Spawn.new(0, Enemy.Types.E1, MovLinear.new(Util.right(16, 0.5), Values.ENEMY_SPEED, 0))]
			spawns.append_array(circle(
				[Enemy.Types.E1, Enemy.Types.E1, Enemy.Types.E1, Enemy.Types.E1],
				Util.right(16, 0.5),
				Values.ENEMY_SPEED, 32, 1, 0
			))
			return spawns
